...
if chrome_sel != "— Selecciona —":
    ...
    if usuario_actual and usuario_actual != "-":
        st.markdown(f"<div style='font-size:0.8rem; color: #8b92b8; margin-bottom:0.5rem'>👤 Asignado a: <b style='color:#e8eaf6'>{usuario_actual}</b></div>", unsafe_allow_html=True)
